  ...
  return (
    <>
      <button
        ...
        className="lg:hidden inline-flex items-center justify-center h-10 w-10 rounded-xl border border-shell-border bg-shell-elevated/70 text-shell-warm hover:border-shell-accent/30 hover:text-shell-accent transition-colors"
        ...
        {open && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 z-50 w-[min(88vw,20rem)] flex flex-col border-r border-shell-border bg-shell-sidebar shadow-2xl lg:hidden"
            >
