 ...
 * birth-detail entry points — `BirthDetailsFields`, `VerticalChartReport`,
 * `ChartSectionResult` — can share the exact same labels without importing
 * the full workspace, and so it stays inside a catalog path the
...
export const chartFormCopy = {
  en: {
    ...
    tabTitles: { D1: "Natal Chart (Lagna)", D9: "Navamasha Chart(D9)", D10: "Dashamsha Chart (D10)", Chalit: "Bhava Chalit", Chandra: "Moon Chart", Gochar: "Transit Overlay", Details: "Planetary Details", Aspects: "Vedic Aspects (Drishti)", Dasha: "Vimshottari Dasha" },
    ...
    ui: { textToggle: "Text", symbolToggle: "Symbols", transitBadge: "Transit Overlay", northStyle: "North Indian", southStyle: "South Indian", asc: "ASC", nakshatraLabel: "Nakshatra", house: "House", retrograde: "Ret.", pada: "Pada", lord: "Lord", aspects: "Aspects Houses", resetChart: "New chart", sectionsNavAria: "Chart view", summaryTitle: "Summary", summaryLagna: "Lagna", summaryMoonSign: "Moon Sign", summarySunSign: "Sun Sign", summaryCurrentDasha: "Current Period", readFullExplanation: "Read the full explanation", dignity: { Exalted: "Exalted", Debilitated: "Debilitated", "Own Sign": "Own Sign", Neutral: "Neutral" } },
  ...
  hi: {
    ...
    tabTitles: { D1: "जन्म कुण्डली (लग्न)", D9: "नवमांश कुण्डली", D10: "दशमांश कुण्डली (D10)", Chalit: "चलित कुण्डली", Chandra: "चंद्र कुण्डली", Gochar: "गोचर कुण्डली", Details: "ग्रह विवरण", Aspects: "वैदिक दृष्टि (Drishti)", Dasha: "विंशोत्तरी दशा" },
    ...
    ui: { textToggle: "पाठ", symbolToggle: "प्रतीक", transitBadge: "गोचर", northStyle: "उत्तर भारतीय", southStyle: "दक्षिण भारतीय", asc: "ल", nakshatraLabel: "नक्षत्र", house: "भाव", retrograde: "वक्री", pada: "पद", lord: "स्वामी", aspects: "दृष्टि भाव", resetChart: "नया चार्ट", sectionsNavAria: "कुण्डली दृश्य", summaryTitle: "सारांश", summaryLagna: "लग्न", summaryMoonSign: "चंद्र राशि", summarySunSign: "सूर्य राशि", summaryCurrentDasha: "वर्तमान दशा", readFullExplanation: "पूरा विवरण पढ़ें", dignity: { Exalted: "उच्च", Debilitated: "नीच", "Own Sign": "स्वराशि", Neutral: "सम" } },
  ...
  ja: {
    ...
    tabTitles: { D1: "ネイタルチャート (ラグナ)", D9: "D9 チャート", D10: "ダシャムシャ・チャート (D10)", Chalit: "チャリットチャート", Chandra: "チャンドラチャート", Gochar: "トランジットチャート", Details: "惑星の詳細", Aspects: "ヴェーダのアスペクト (Drishti)", Dasha: "ヴィムショッタリ・ダシャー" },
    ...
    ui: { textToggle: "テキスト", symbolToggle: "記号", transitBadge: "トランジット", northStyle: "北インド式", southStyle: "南インド式", asc: "ASC", nakshatraLabel: "ナクシャトラ", house: "室", retrograde: "逆行", pada: "パダ", lord: "支配星", aspects: "アスペクトのハウス", resetChart: "新しいチャート", sectionsNavAria: "チャート表示", summaryTitle: "サマリー", summaryLagna: "ラグナ", summaryMoonSign: "月星座", summarySunSign: "太陽星座", summaryCurrentDasha: "現在の期間", readFullExplanation: "詳しい解説を読む", dignity: { Exalted: "高揚", Debilitated: "減衰", "Own Sign": "本来の座", Neutral: "中立" } },
  ...
  ko: {
    ...
    tabTitles: { D1: "네이탈 차트 (Lagna)", D9: "D9 차트", D10: "다샴샤 차트 (D10)", Chalit: "찰리트 차트", Chandra: "찬드라 차트", Gochar: "트랜짓 차트", Details: "행성 세부 정보", Aspects: "베다 애스펙트 (Drishti)", Dasha: "빔쇼타리 다샤" },
    ...
    ui: { textToggle: "텍스트", symbolToggle: "기호", transitBadge: "트랜짓 오버레이", northStyle: "북인도 방식", southStyle: "남인도 방식", asc: "ASC", nakshatraLabel: "낙샤트라", house: "하우스", retrograde: "역행", pada: "파다", lord: "지배성", aspects: "애스펙트 하우스", resetChart: "새 차트", sectionsNavAria: "차트 보기", summaryTitle: "요약", summaryLagna: "라그나", summaryMoonSign: "달별자리", summarySunSign: "태양별자리", summaryCurrentDasha: "현재 시기", readFullExplanation: "전체 설명 읽기", dignity: { Exalted: "고양", Debilitated: "쇠약", "Own Sign": "자신의 별자리", Neutral: "중립" } },
