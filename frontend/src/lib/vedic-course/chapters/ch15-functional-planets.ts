...
export const chapter15FunctionalPlanets: CourseChapter = {
  id: "ch15",
  number: 15,
  title: { en: "Functional Benefics & Houses", ja: "功能的吉星とハウス" },
  subtitle: {
  ...
  steps: [
    {
      ...
      kind: "content",
      icon: "sparkles",
      title: { en: "Natural vs Functional", ja: "天然 vs 功能的" },
      body: {
        ...
        ja: "すべての惑星に天然の性質があります — 木星は天然吉星、土星は天然厳しい。しかしジョーティシュでは、あなたのアセンダントが支配するハウスによって功能的吉星または凶星にもなります。西洋占星術に直接の同等物はありません。",
      },
      highlight: {
        en: "The Ascendant is the master key — it sets benefic/malefic status for every planet.",
        ja: "アセンダントがマスターキー — すべての惑星の吉/凶ステータスを設定する。",
      },
    },
    {
      id: "ch15-s1",
      ...
      body: {
        ...
        ja: "火星は天然凶星 — しかしシンハ（獅子）アセンダントでは第4と第9ハウスを支配し、非常にポジティブな功能的吉星に。カニヤ（乙女）アセンダントでは第6と第11を支配 — 強く不利。",
      },
      bullets: [
    ...
    },
    {
      ...
      body: {
        ...
        ja: "金星は天然の大吉星 — しかしミーナ（魚）アセンダントでは支配ハウスのためかなり不利になることがある。 「吉星」がすべてのチャートで常に良いと決めてはいけない。",
      },
      bullets: [
        { en: "Planets ruling 1st, 5th, or 9th are generally auspicious (broad rule)", ja: "第1・5・9を支配する惑星は一般に吉（大まかなルール）" },
        { en: "Planets ruling 6th, 8th, or 12th tend toward functional malefic", ja: "第6・8・12を支配する惑星は功能的凶星に傾く" },
    ...
    },
    {
      ...
      bullets: [
        ...
        { en: "Determines gemstone remedies and functional planet status", ja: "宝石レメディと功能的惑星ステータスを決定" },
      ],
    },
    {
      id: "ch15-s4",
      ...
      body: {
        ...
        ja: "功能的吉星には宝石で強化。功能的凶星にはマントラ — 宝石は決して（害を増幅する）。レメディ前に常にアセンダントで全チャートを分析。",
      },
      highlight: {
    ...
    },
    {
      id: "ch15-flash",
      kind: "flashcards",
      title: { en: "Functional Planet Flashcards", ja: "功能的惑星 フラッシュカード" },
      instruction: {
        en: "Natural vs functional — flip each card to master the distinction.",
        ja: "天然 vs 功能的 — 各カードを裏返して区別をマスター。",
      },
      cards: [
        { id: "f1", front: { en: "Natural benefic", ja: "天然吉星" }, back: { en: "Jupiter, Venus (generally gentle)", ja: "木星・金星（おおむね穏やか）" }, icon: "sparkles" },
        { id: "f2", front: { en: "Natural malefic", ja: "天然凶星" }, back: { en: "Saturn, Mars, Rahu, Ketu", ja: "土星・火星・ラーフ・ケートゥ" }, icon: "flame" },
        { id: "f3", front: { en: "Functional benefic", ja: "功能的吉星" }, back: { en: "Auspicious for YOUR Ascendant", ja: "あなたのアセンダントに吉" }, icon: "sun" },
        { id: "f4", front: { en: "Functional malefic", ja: "功能的凶星" }, back: { en: "Unfavourable for YOUR Ascendant", ja: "あなたのアセンダントに不利" }, icon: "mountain" },
        { id: "f5", front: { en: "Mars + Leo Lagna", ja: "火星＋獅子ラグナ" }, back: { en: "Functional benefic (rules 4th & 9th)", ja: "功能的吉星（第4・9支配）" }, icon: "flame" },
    ...
    },
    {
      ...
      instruction: {
        ...
        ja: "各アセンダントシナリオを火星または金星の功能的役割にマッチ。",
      },
      pairs: [
        { leftId: "leo", left: { en: "Simha (Leo) Ascendant + Mars", ja: "シンハ（獅子）アセンダント＋火星" }, rightId: "ben", right: { en: "Functional benefic", ja: "功能的吉星" }, leftIcon: "sun" },
        { leftId: "vir", left: { en: "Kanya (Virgo) Ascendant + Mars", ja: "カニヤ（乙女）アセンダント＋火星" }, rightId: "mal", right: { en: "Functional malefic", ja: "功能的凶星" }, leftIcon: "flame" },
        ...
        { leftId: "gem", left: { en: "Functional benefic planet", ja: "功能的吉星" }, rightId: "stone", right: { en: "Gemstone remedy OK", ja: "宝石レメディOK" }, leftIcon: "sparkles" },
        { leftId: "man", left: { en: "Functional malefic planet", ja: "功能的凶星" }, rightId: "mantra", right: { en: "Mantra remedy preferred", ja: "マントラレメディ推奨" }, leftIcon: "wind" },
      ],
    },
    {
      id: "ch15-order",
      ...
      items: [
        ...
        { id: "func", label: { en: "Classify functional benefic vs malefic", ja: "功能的吉星 vs 凶星を分類" }, icon: "eye" },
    ...
    },
    {
      id: "ch15-tf",
      kind: "true-false",
      title: { en: "Functional Planets: True or False", ja: "功能的惑星 マルバツ" },
      instruction: { en: "3 of 4 correct to pass.", ja: "4問中3問正解で合格。" },
      statements: [
        {
          id: "c15tf1",
          statement: { en: "Venus is always beneficial for every Ascendant because it's a natural benefic.", ja: "金星は天然吉星なのですべてのアセンダントで常に有益だ。" },
          isTrue: false,
          explanation: { en: "Functional status depends on house rulership — e.g. Venus for Pisces Lagna.", ja: "機能ステータスはハウス支配次第 — 例：魚ラグナの金星。" },
        },
        {
          id: "c15tf2",
          statement: { en: "Western astrology has a direct equivalent to functional benefics.", ja: "西洋占星術には功能的吉星の直接の同等物がある。" },
          isTrue: false,
          explanation: { en: "Functional benefic/malefic based on Ascendant house rulership is unique to Jyotish.", ja: "アセンダントのハウス支配に基づく功能的吉/凶星はジョーティシュ独自。" },
        },
        {
          id: "c15tf3",
        ...
        {
          id: "c15tf4",
          statement: { en: "You should wear a gemstone for a functional malefic to reduce its harm.", ja: "功能的凶星の害を減らすためその宝石を着けるべきだ。" },
          isTrue: false,
    ...
    },
    {
      ...
      options: [
        { id: "func", label: { en: "Functional benefic/malefic status of planets", ja: "惑星の功能的吉/凶ステータス" }, icon: "layers" },
      ...
      explanation: {
        ...
        ja: "ラグナが功能的惑星・ハウス星座・レメディ・外見的自己を設定 — 太陽星座コラムや外惑星ではない。",
      },
    },
    {
      id: "ch15-quiz",
      ...
      question: {
        ...
        ja: "火星が第4と第9ハウスを支配。どのアセンダントで火星が功能的吉星か？",
      },
      options: [
      ...
      explanation: {
        ...
        ja: "獅子アセンダント：第4・9支配星としての火星は強力な功能的吉星になる。",
      },
    },
  ],
};
